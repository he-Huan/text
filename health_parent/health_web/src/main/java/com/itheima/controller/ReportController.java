...
public class ReportController {
    ...
    public Result getPackageReport() {
        // 查询套餐占比数据,Map<String,Object>:value:数量，name：套餐名称，每一个套餐就是一个map
    ...
    public Result exportBusinessReport2(HttpServletResponse res, HttpServletRequest req) {
        // 调用业务服务查询运营数据
        Map<String, Object> map = reportService.getBusinessReportData();
        // 写到excel中
        // 1.获取模板getRealPath:webapp
