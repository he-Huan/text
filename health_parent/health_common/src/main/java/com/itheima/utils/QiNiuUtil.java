...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "aHrCBuSwn3SNY2vrIEApcHTRojfoZBtYmUFY24o6";
    private static final String SECRETKEY = "jAoydsvdVvuZahSKfiIJ3255lhJv0xIjaITjViaw";
    private static final String BUCKET = "huanhe";
    public static final String DOMAIN= "pybreuspn.bkt.clouddn.com";
